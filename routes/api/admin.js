...
//(((((((((((((((((((((((((((((((((((((((((((())))))))))))))))))))))))))))))))))))))))))))
 ...
 async function shareAutopoolLevelMoney(){
    ...
    .then(async users => {
        console.log(users);
        console.log("aesdhfjhgfngtfjfjhfjhgfhgfjhgfjhtfjhvgvfhgfhgchgfcgc",users.length);
           if(users)
           {

                    const userids = users.map(user => user._id)
                    const userqwe = users.map(user => user.userId)
console.log(userids);
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "BRONZE TREASURE : level 1 amount added",
                                            Amountadded: 2,
                                            pinsadded: 0,
                                            total: 2
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "BRONZE TREASURE : level 2 amount added",
                                            Amountadded: 16,
                                            pinsadded: 0,
                                            total: 16
        ...
        .then(user => {
            if(user){
                ...
                .then(resp => {
                    ...
                    DailyReport.findOneAndUpdate({ dateId : today},{
                        $inc : {
                            PoolOutgo : parseFloat(98),
                            PoolOnePinsIncome: parseFloat(30)
                        }
                    }).then(document => {
                        if(!document)
                        {
...
async function shareAutopoolTwoLevelMoney(){

    await Autopool2.find({
        levelOneIncome : 32
    })
    .select("userId")
    .then(async users => {
        console.log(users);
        console.log("aesdhfjhgfngtfjfjhfjhgfhgfjhgfjhtfjhvgvfhgfhgchgfcgc 2",users.length);
           if(users)
           {
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "SILVER TREASURE : level 1 amount added",
                                            Amountadded: 32,
                                            pinsadded: 0,
                                            total: 32
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "SILVER TREASURE : level 2 amount added",
                                            Amountadded: 128,
                                            pinsadded: 0,
                                            total: 128
...
async function shareAutopoolThreeLevelMoney(){

    await Autopool3.find({
        levelOneIncome : 52
    })
    .select("userId")
    .then(async users => {
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "GOLD TREASURE : level 1 amount added",
                                            Amountadded: 52,
                                            pinsadded: 0,
                                            total: 52
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                    const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "GOLD TREASURE : level 2 amount added",
                                            Amountadded: 208,
                                            pinsadded: 0,
                                            total: 208
...
async function shareAutopoolFourLevelMoney(){

    await Autopool4.find({
        levelOneIncome : 104
    })
    .select("userId")
    .then(async users => {
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "PLATINUM TREASURE : level 1 amount added",
                                            Amountadded: 104,
                                            pinsadded: 0,
                                            total: 104
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                    const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "PLATINUM TREASURE : level 2 amount added",
                                            Amountadded: 416,
                                            pinsadded: 0,
                                            total: 416
...
async function shareAutopoolFiveLevelMoney(){

    await Autopool5.find({
        levelOneIncome : 160
    })
    .select("userId")
    .then(async users => {
        console.log(users);
        console.log("aesdhfjhgfngtfjfjhfjhgfhgfjhgfjhtfjhvgvfhgfhgchgfcgc 5",users.length);
           if(users)
           {
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "DIAMOND TREASURE : level 1 amount added",
                                            Amountadded: 160,
                                            pinsadded: 0,
                                            total: 160
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                    const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "DIAMOND TREASURE : level 2 amount added",
                                            Amountadded: 640,
                                            pinsadded: 0,
                                            total: 640
...
async function shareAutopoolSixLevelMoney(){

    await Autopool6.find({
        levelOneIncome : 212
    })
    .select("userId")
    .then(async users => {
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "MILLION TREASURE : level 1 amount added",
                                            Amountadded: 212,
                                            pinsadded: 0,
                                            total: 212
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                    const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "MILLION TREASURE : level 2 amount added",
                                            Amountadded: 848,
                                            pinsadded: 0,
                                            total: 848
...
async function shareAutopoolSevenLevelMoney(){

    await Autopool7.find({
        levelOneIncome : 320
    })
    .select("userId")
    .then(async users => {
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "BILLION TREASURE : level 1 amount added",
                                            Amountadded: 320,
                                            pinsadded: 0,
                                            total: 320
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                    const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "BILLION TREASURE : level 2 amount added",
                                            Amountadded: 1280,
                                            pinsadded: 0,
                                            total: 1280
...
//===================================================================================================
//=======================================****** Autopool 8 ******====================================
async function shareAutopoolEightLevelMoney(){

    await Autopool8.find({
        levelOneIncome : 532
    })
    .select("userId")
    .then(async users => {
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "TRILLION TREASURE : level 1 amount added",
                                            Amountadded: 532,
                                            pinsadded: 0,
                                            total: 532
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                       const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "TRILLION TREASURE : level 2 amount added",
                                            Amountadded: 2128,
                                            pinsadded: 0,
                                            total: 2128
...
//===================================================================================================
//=======================================****** Autopool 9 ******====================================
async function shareAutopoolNineLevelMoney(){

    await Autopool9.find({
        levelOneIncome : 800
    })
    .select("userId")
    .then(async users => {
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "CROWN TREASURE : level 1 amount added",
                                            Amountadded: 800,
                                            pinsadded: 0,
                                            total: 800
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                       const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "CROWN TREASURE : level 2 amount added",
                                            Amountadded: 3200,
                                            pinsadded: 0,
                                            total: 3200
...
//===================================================================================================
//=======================================****** Autopool 10 ******====================================
async function shareAutopoolTenLevelMoney(){

    await Autopool10.find({
        levelOneIncome : 1064
    })
    .select("userId")
    .then(async users => {
                            ...
                            .then(async re => {
                              ...
                              users.map( user =>{
                                        const poolstatement = new PoolStatement({
                                            ...
                                            userId: user.userId,
                                            poolName: "ACE TREASURE : level 1 amount added",
                                            Amountadded: 1064,
                                            pinsadded: 0,
                                            total: 1064
